# ********************************************************************
# Name    : Exceptions
# Summary : Contains custom Exception classes, all of which should be
#           matched to one of the parent classes.
# ********************************************************************
...
class EnmUtilsException(Exception):
    pass


class EnmApplicationError(EnmUtilsException):
    pass


class ProfileError(EnmUtilsException):
    pass


class NetsimError(EnmUtilsException):
    pass


class EnvironError(EnmUtilsException):
    pass


class EnvironWarning(EnmUtilsException):
    pass


class ProfileWarning(EnvironWarning):
    pass
...
class ScriptEngineResponseValidationError(EnmApplicationError):
    def __init__(self, msg, response):
        ...
        super(ScriptEngineResponseValidationError, self).__init__(self.message)
...
class NoNodesWithReqMosOnEnm(EnvironError):
    pass


class NoRequestedMoInfoOnEnm(EnvironError):
    pass
...
class RemoveUndoJobError(EnmApplicationError):
    pass
...
class ValidationError(EnmUtilsException):
    pass
...
class SessionNotEstablishedException(EnmApplicationError):
    pass
...
class NotAllNodeTypesAvailable(EnvironWarning):
    pass
...
class RemoveProfileFromNodeError(ProfileWarning):
    pass


class AddProfileToNodeError(ProfileWarning):
    pass
...
class DependencyException(RuntimeError):
    ...
    def __init__(self, host, command, error):
        ...
        self.message = "ERROR\n    Host: {hostname}\n    Command: {command}\n    Error: {error}".format(
            hostname=self.host, command=self.command, error=self.error)
...
class UserUpdateError(EnmApplicationError):
    pass


class MOPathMisMatch(EnvironError):
    pass


class InvalidOpenapiFormat(Exception):

    def __init__(self, message, service_name):
        self.service_name = service_name
        self.message = '{0}. Update Openapi specification for {1}'.format(message, self.service_name)
        super(InvalidOpenapiFormat, self).__init__(self.message)
