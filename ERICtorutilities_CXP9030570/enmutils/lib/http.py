# ********************************************************************
# Name    : HTTP
# Summary : Provides a basic class for both HTTP artifacts, along
#           with basic RESTful requests.
# ********************************************************************
...
#
if hasattr(requests, "packages") and hasattr(requests.packages, "urllib3"):  # pragma:no cover
