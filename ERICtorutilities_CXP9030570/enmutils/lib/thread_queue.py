# ********************************************************************
# Name    : Thread Queue
# Summary : Two main classes ThreadQueue and ThreadQueueEntry, each
#           worker is an instance of ThreadQueueEntry and are spawned
#           and managed by ThreadQueue instance.
# ********************************************************************
...
class ThreadQueue(object):
    ...
    def __init__(self, work_items=None, num_workers=0, func_ref=None, args=None, task_join_timeout=None,
        ...
        :type task_wait_timeout: int
        :param task_wait_timeout: Number of seconds for task to wait
        """
