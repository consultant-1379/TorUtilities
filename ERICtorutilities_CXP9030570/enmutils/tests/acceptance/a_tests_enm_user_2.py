...
from enmutils.lib.enm_user_2 import User, get_or_create_admin_user
...
class EnmUserAcceptanceTests(unittest2.TestCase):
    ...
    def setUp(self):
        ...
        self.user = User('enm_utils_acceptance_tests_user1', 'TestPassw0rd', roles=['FIELD_TECHNICIAN'], establish_session=True)
