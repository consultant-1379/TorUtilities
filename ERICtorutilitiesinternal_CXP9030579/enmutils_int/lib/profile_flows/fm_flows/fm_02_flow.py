...
class Fm02(FMAlarmFlow):
    MSC_RATE = None
    BSC_RATE = None
    CPP_RATE = None
    SNMP_RATE = None

    def execute_fm_02_alarm_rate_normal_flow(self):
        """
        This function executes the main flow for FM_02
        """
        burst_id = "222"
        load_mgr.wait_for_setup_profile("FM_0506")
        log.logger.debug("FM Alarm rate node distribution: ERBS, Radio Nodes, MGw, SGSN-MME, RNC and RBS nodes")
