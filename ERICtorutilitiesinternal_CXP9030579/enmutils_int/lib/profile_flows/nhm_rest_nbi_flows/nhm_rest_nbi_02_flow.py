...
from enmutils_int.lib.nhm_rest_nbi import LAST_FOUR_ROP_REQUEST


class NhmNbi02Flow(NhmRestNbiFlow):

    def execute_flow(self):
        """
        Executes the Main flow for Nhm_rest_nbi_02 profile
        """
        self.state = "RUNNING"
        ...
        while self.keep_running():
            ...
            try:
                ...
                self.kpi_execution_nhm_rest_nbi(operator_users[0], node_level_kpi, fdn_values, LAST_FOUR_ROP_REQUEST)
